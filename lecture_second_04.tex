...
% Auto-generated from YAML (v3) — 04: 情報通信ネットワーク（デジタル通信の仕組み）
...
\begin{frame}{今日の目標}
  \begin{block}{この授業が終わったらできること}
    \begin{itemize}
      \item ネットワークの仕組みや構成，プロトコルの役割を説明できる
    \end{itemize}
  \end{block}
\end{frame}
...
\begin{frame}{まとめ・チェックリスト}
  \begin{block}{自己チェック（できたら $\checkmark$ をつけよう）}
    \begin{itemize}
      \item[$\square$] パケット交換方式とTCP/IPの仕組みを理解した
      \item[$\square$] IPアドレスとMACアドレスの役割と違いを学んだ
      \item[$\square$] 有線・無線LANなどインターネット接続方法の種類を把握した
    \end{itemize}
  \end{block}
