...
\begin{frame}{16進法}
  ...
  \begin{slidenote}
    2進→16進の変換：右から4ビットずつ区切り，各グループを16進1桁に変換する。例：$\underbrace{1101}_{\text{D}}\underbrace{1110}_{\text{E}}{}_{(2)}=\text{DE}_{(16)}$。Webの色指定 \texttt{\#FF0000} → R=FF(255), G=0, B=0 → 赤。MACアドレス（例：00-1A-2B-3C-4D-5E）も16進表記。【演習解答】1101=D，1110=E → DE(16)
  \end{slidenote}
\end{frame}
