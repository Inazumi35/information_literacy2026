...
% Auto-generated from YAML (v3) — 13: データサイエンス・AI（6）：生成AIと倫理的課題
...
\begin{frame}{\CourseName\quad 第\LectureNum 回「\LectureTitle 」}
  ...
  \begin{block}{今日の目標}
    \begin{itemize}
      \item 実世界で進む生成AIの応用と革新について説明できる。
    \end{itemize}
  \end{block}
  \vfill

  \begin{exampleblock}{キーワード}
    \small \textbf{生成AI} ／ \textbf{テキスト生成AI} ／ \textbf{画像生成AI} ／ \textbf{その他}
  \end{exampleblock}
\end{frame}
...
\begin{frame}{まとめ・チェックリスト}
  \begin{block}{自己チェック（できたら $\checkmark$ をつけよう）}
    \begin{itemize}
      \item[$\square$] 生成AIの種類（テキスト・画像・動画生成）と仕組みを理解した
      \item[$\square$] 著作権・偽情報・プライバシーなど生成AIの倫理的課題を学んだ
      \item[$\square$] NotebookLMとCopilotを比較し，批判的思考の重要性を考えた
    \end{itemize}
  \end{block}
