...
\begin{frame}{\CourseName\quad 第\LectureNum 回「\LectureTitle 」}
  ...
  \begin{exampleblock}{キーワード}
    \small \textbf{情報システム} ／ \textbf{POSシステム（Point Of Sales system）} ／ \textbf{GPS（Global Positioning System）} ／ \textbf{VR（Virtual Reality：仮想現実）} ／ \textbf{AR（Augmented Reality：拡張現実）} ／ \textbf{MR（Mixed Reality：複合現実）}
  \end{exampleblock}
\end{frame}
...
\begin{frame}{演習}
  ...
  \begin{block}{演習1}
    集中情報システムと分散情報システムの違いを，機密性・完全性・可用性の観点から説明せよ
  \end{block}
  \vfill

  \begin{block}{演習2}
    オープンデータの3つの条件を説明し，身近な活用例を1つ挙げよ
  \end{block}
  \vfill

  \begin{block}{演習3}
    MTBFが900時間，MTTRが100時間のシステムの稼働率を求めよ
  \end{block}
\end{frame}
